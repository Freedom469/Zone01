...
func main() {
	input := "it (up, 7) was the best of TIMES (up, 3) , it was the worst of times (cap), it was the age of wisdom, it was the age of foolishness Hello World  (up, 10) "
	...
	// input := "I was sitting ' over there dont't ,and  ' then BAMM !!"

	EditedInput := PunctuationMark(Vowel(input))
	...
	fmt.Println(punctuation(strings.Join(words, " ")))
}
